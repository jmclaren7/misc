...
<form action="" method="post" class="pt-3">
    ...
    <div class="row">
        ...
        <div class="col-3 d-none d-sm-block"><a href="" target="_blank" class="float-right text-muted"><?php echo VERSION; ?></a></div>
        <?php else: ?>
...
function lng($txt) {
    ...
    // English Language
    $tr['en']['AppName']        = 'Tiny File Manager';      $tr['en']['AppTitle']           = APP_TITLE;
